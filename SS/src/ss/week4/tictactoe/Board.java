...
public class Board {
    ...
    public boolean isEmptyField(int row, int col) {
        return getField(index(row, col)).equals(Mark.EMPTY);
    }
    ...
    public boolean hasRow(Mark m) {
    	for (int i = 0; i < DIM; i++) {
    		if (getField(i * 3).equals(m) && getField(i * 3 + 1).equals(m) && getField(i * 3 + 2).equals(m)) {
    			return true;
    		}
    	}
    	return false;
    ...
    public boolean hasDiagonal(Mark m) {
    	if ((getField(0).equals(m) && getField(8).equals(m) || 
    				 getField(2).equals(m) && getField(6).equals(m)) && getField(4).equals(m)) {
    		return true;
    	}
        return false;
    }
